...
You are working in the `Anime-Stitch-Pipeline` repository. Before making changes:
...
3. Check `moon/ROADMAP.md` for planned work that might conflict with the requested change.
