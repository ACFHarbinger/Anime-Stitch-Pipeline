...
from asp_backend.evaluation.ui.image_panel import ImagePanel  # noqa: E402
from asp_backend.evaluation.ui.panel_grid import PanelGrid  # noqa: E402
from asp_backend.evaluation.ui.scoring_panel import ScoringPanel  # noqa: E402
...
def test_edge_builder_needs_two_before_it_can_finish():
    from asp_backend.evaluation.ui.annotations import EdgeBuilder
...
def test_overlay_renders_a_pending_chain_across_panels(qapp):
    from asp_backend.evaluation.other.schema import EdgePoint
    from asp_backend.evaluation.ui.annotations import EdgeOverlay
...
def test_restoring_bboxes_after_a_reload_does_not_accumulate(panel):
    from asp_backend.evaluation.other.schema import BoundingBox
...
def restore_dark_theme(qapp):
    from asp_backend.evaluation.ui.theme import apply_theme
...
def test_grid_refresh_theme_updates_the_focused_chips_inline_style(grid, restore_dark_theme):
    from asp_backend.evaluation.ui.theme import apply_theme, current_palette
...
def scoring(qapp):
    ...
    from asp_backend.evaluation.other.schema import RatingEntry
