  ...
  <div class="layout">
    <header class="topbar">
      <div class="topbar-left">
        <button class="menu-btn" @click="sidebarOpen = !sidebarOpen" aria-label="Toggle navigation">
          <svg viewBox="0 0 20 20" width="18" height="18" fill="none">
            <path d="M3 5h14M3 10h14M3 15h14" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" />
          </svg>
        </button>
        <router-link to="/" class="brand">
          <span class="brand-mark">ASP</span>
          <span class="brand-name">Anime-Stitch-Pipeline</span>
        </router-link>
      </div>
      <div class="topbar-right">
        ...
        <a
          class="icon-link"
          href="https://github.com/ACFHarbinger/Anime-Stitch-Pipeline"
          target="_blank"
